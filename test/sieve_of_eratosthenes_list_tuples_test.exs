defmodule Primes.SieveOfEratosthenes.List.Tuples.Test do
  use ExUnit.Case, async: true
  doctest Primes.SieveOfEratosthenes.List.Tuples
  ...
  test "Returns 2 for the smallest upper limit" do
    prime = Primes.SieveOfEratosthenes.List.Tuples.get_primes_list(2)
  ...
  do
    calculated_primes = Primes.SieveOfEratosthenes.List.Tuples.get_primes_list(thousand_primes_max)
  ...
  # do
  #   calculated_primes = Primes.SieveOfEratosthenes.List.Tuples.get_primes_list(million_primes_max)
  #
